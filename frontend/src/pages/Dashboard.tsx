    ...
    <div style={{ backgroundColor: '#121212', color: '#e0e0e0', minHeight: '100vh', padding: '40px 20px', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      <div style={{ maxWidth: '900px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px' }}>
          <h1 style={{ color: '#ffffff', margin: 0, fontWeight: '600' }}>
            Controle de Estoque
          </h1>
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
            <span style={{ color: '#a0a0a0', fontSize: '14px' }}>Olá, {user?.username}</span>
            <button onClick={signOut} style={{ ...primaryButtonStyle, backgroundColor: '#ef4444', padding: '6px 12px', fontSize: '13px' }}>
              Sair
            </button>
          </div>
        </div>
        ...
        <div style={{ backgroundColor: '#1e1e1e', padding: '24px', borderRadius: '12px', marginBottom: '32px', border: '1px solid #2a2a2a' }}>
          ...
          <form onSubmit={handleCreateProduct} style={{ display: 'flex', gap: '16px', alignItems: 'flex-end', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1, minWidth: '150px' }}>
              <label style={{ display: 'block', fontSize: '13px', marginBottom: '6px', color: '#a0a0a0' }}>Categoria</label>
              <select 
